...
const features = [
  {
    ...
    description: "With intelligent features that adapt to how you use your iPhone, everything becomes more personalized.",
  ...
  },
  {
    ...
    image: "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-15-finish-select-202309-6-7inch-blue?wid=5120&hei=2880&fmt=p-jpg&qlt=80&.v=1692923777972",
  ...
  },
  {
    ...
    image: "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-15-pro-model-unselect-gallery-1-202309?wid=5120&hei=2880&fmt=p-jpg&qlt=80&.v=1693010531869",
  ...
  },
  {
    ...
    image: "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-15-finish-select-202309-6-7inch-pink?wid=5120&hei=2880&fmt=p-jpg&qlt=80&.v=1692923777519",
  ...
  return (
    <div className="bg-black min-h-screen" ref={component}>
      ...
      <main className="pt-[120px]">
        {/* Hero Section */}
        <section className="max-w-[1200px] mx-auto px-4 py-20 text-center relative">
          <h1 className="text-7xl font-bold mb-6 bg-gradient-to-r from-white via-gray-300 to-gray-500 text-transparent bg-clip-text">
            iPhone 15
          </h1>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="relative z-10">
                  ...
                  <h2 className="text-3xl font-semibold mb-4">{feature.subtitle}</h2>
        ...
        {/* Models Section */}
        <section className="bg-white text-black py-20 models-section">
          <div className="max-w-[980px] mx-auto px-4">
            <h2 className="text-4xl font-semibold mb-2">Which iPhone is right for you?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
              {models.map((model, index) => (
                <div key={index} className="model-card text-center">
                  <img 
                    src={model.image}
                    alt={model.name}
                  ...
                  <p className="text-gray-500 text-sm mb-4">From {model.monthly} with instant cashback*</p>
                  <Link 
            ...
            <p className="text-center text-sm text-gray-500 mt-8">
              * Instant cashback available with eligible cards. EMI available with most leading banks.
            </p>
          </div>
        </section>
      </main>
